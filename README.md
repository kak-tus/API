...
Подписки – предоставление абоненту доступа к контенту. Абонент соглашается на подписку на странице оператора связи (landing page). Оператор связи списывает средства с сим карты абонента. Списание средств и предоставление доступа прекращается при выполнении одного из следующих условий - отписался абонент, закончился срок подписки, нет достаточного колличества средств на счету. Тарификация подписавшегося абонента происходит ежедневно.
...
С вопросами обращайтесь к менеджерам, по электронной почте, через web-форму обратной связи по адресу, по бесплатному телефону.
